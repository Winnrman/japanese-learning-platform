    ...
    <>
      <div className="w-screen h-screen">
        ...
        <div className="w-screen h-full p-1 bg-slate-100">
          <QuickModules />
          <button onClick = {beginLesson} className = "flex flex-row items-center justify-center px-2 py-1 hover:bg-slate-600 hover:cursor-pointer hover:text-white m-2 rounded-md bg-slate-300">
          Begin Lesson
        </button>
        </div>
