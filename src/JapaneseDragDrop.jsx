...
const JapaneseDragDrop = () => {
  ...
  const exercises = [
  {
    ...
    wordPool: ["すし", "と", "ごはん", "おねがいします", "みず", "を", "ください", "おちゃ"],
  ...
  },
  {
    ...
    wordPool: ["わたし", "は", "みず", "を", "のみます", "たべます", "ごはん", "コーヒー"],
  ...
  },
  {
    ...
    wordPool: ["わたし", "は", "すし", "を", "たべます", "のみます", "りんご", "おちゃ"],
  ...
  },
  {
    ...
    solution: ["おはよう", "ございます"],
    wordPool: ["おはよう", "ございます", "こんばんは", "ありがとう", "さようなら", "こんにちは"],
  ...
  },
  {
    ...
    english: "Good night",
    solution: ["おやすみ", "なさい"],
    wordPool: ["おやすみ", "なさい", "こんにちは", "ありがとう", "おはよう", "こんばんは"],
  ...
  },
  {
    ...
    wordPool: ["わたし", "は", "ねこ", "が", "すき", "です", "いぬ", "きらい"],
  ...
  },
  {
    ...
    solution: ["みず", "を", "ください"],
    wordPool: ["みず", "を", "ください", "おちゃ", "おねがいします", "と", "すし"],
  ...
  },
  {
    ...
    wordPool: ["わたし", "は", "がくせい", "です", "せんせい", "いぬ", "ねこ", "が"],
  ...
  },
  {
    ...
    wordPool: ["はじめまして", "よろしく", "おねがいします", "ありがとう", "こんにちは", "さようなら"],
  ...
  },
  {
    ...
    wordPool: ["トイレ", "は", "どこ", "です", "か", "がくせい", "わたし", "すき"],
  ...
  },
  {
    ...
    wordPool: ["それは", "コーヒー", "です", "おちゃ", "すし", "ほん", "ねこ"],
  ...
  },
  {
    ...
    wordPool: ["わたし", "は", "にほんご", "が", "わかります", "はなします", "すき"],
  ...
  },
  {
    ...
    solution: ["わかりません"],
    wordPool: ["わかりません", "わかります", "たべます", "いきます", "みます"],
  ...
  },
  {
    ...
    english: "Let's eat",
    solution: ["たべましょう"],
    wordPool: ["たべましょう", "のみましょう", "たべます", "いきましょう", "します"],
  ...
  },
  {
    ...
    wordPool: ["おちゃ", "を", "のみましょう", "たべましょう", "すし", "ください"],
    wordData: srs.initializeWord("suggestion", 'grammar', 4)
  },
  {
    id: 22,
    ...
    wordPool: ["わたし", "は", "がっこう", "へ", "いきます", "きます", "たべます"],
  ...
  },
  {
    ...
    wordPool: ["わたし", "の", "なまえ", "は", "ジョン", "です", "あなた", "すき"],
  ...
  },
  {
    ...
    wordPool: ["わたし", "は", "にほんご", "を", "はなします", "たべます", "すき"],
  ...
  },
  {
    ...
    wordPool: ["にほんご", "は", "むずかしい", "です", "たのしい", "すき", "かんたん"],
  ...
  const checkSolution = () => {
    ...
    const quality = correct ? 
      (responseTime < 15000 ? 5 : 4) : // Faster completion = better
      (responseTime < 20000 ? 2 : 1);  // Slower wrong answers = worse
  ...
  const nextExercise = () => {
    ...
    loadExercise(exercises[nextIndex]);
  };
  ...
  return (
    <div className="drag-drop-container">
      ...
      <div className="sentence-container">
        {currentExercise && sentenceSlots.map((word, index) => (
          <DropSlot
            key={index}
            index={index}
      ...
      {submitted && (
        <div className={`feedback ${isCorrect ? 'correct' : 'incorrect'}`}>
          {isCorrect ? (
            ...
            <>
              <h3>不正解 (Incorrect)</h3>
              <p>The correct sentence is: {currentExercise.solution.join(' ')}</p>
            </>
          )}
